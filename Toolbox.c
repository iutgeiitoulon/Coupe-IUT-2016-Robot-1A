...
void Recule(double D)
{
    robotState.AligneAvantVersDirectionMouvement = 0;
    SetRobotTargetPosition(robotState.xPosFromOdometry + D * sin(robotState.angleRadianFromOdometry),
            robotState.yPosFromOdometry - D * cos(robotState.angleRadianFromOdometry));
}
